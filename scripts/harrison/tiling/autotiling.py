# autotiling.py, Harrison Hall

# For running correct pip: C:\Users\hchall\Local Settings\Application Data\Programs\Python\Python37\Scripts
...
screenx, screeny = (GetSystemMetrics(0),GetSystemMetrics(1)) # Starts from 0,0 in top-left
...
while keep_running:
	...
	for i, (handle,app) in enumerate(zip(managed_window_handles,apps)):
		try:
			...
			app.window(handle=handle).move_window(x=xpos,y=ypos,width=width,height=height)
		except:
