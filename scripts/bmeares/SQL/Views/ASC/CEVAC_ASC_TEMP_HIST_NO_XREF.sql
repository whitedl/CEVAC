...
AND TABLE_NAME='CEVAC_ASC_TEMP_HIST'
AND TABLE_TYPE ='VIEW')
BEGIN
-- If the view exists, the code in this block will run.
DROP VIEW CEVAC_ASC_TEMP_HIST
END
GO


CREATE VIEW CEVAC_ASC_TEMP_HIST AS

SELECT
	
--	xref.Alias as Alias,
--	NOTE: Uncomment above line and remove below line once XREF becomes available
...
--	NOTE: uncomment below lines when XREF becomes available
--	INNER JOIN
