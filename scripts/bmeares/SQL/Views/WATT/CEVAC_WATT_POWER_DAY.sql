...
AND TABLE_NAME='CEVAC_WATT_POWER_DAY'
AND TABLE_TYPE ='VIEW')
BEGIN
-- If the view exists, the code in this block will run.
DROP VIEW CEVAC_WATT_POWER_DAY
END
GO
CREATE VIEW CEVAC_WATT_POWER_DAY AS
...
UNION
SELECT * FROM
CEVAC_WATT_POWER_EMERGENCY_DAY
UNION
SELECT * FROM
CEVAC_WATT_POWER_ISOLATED_GROUND_DAY