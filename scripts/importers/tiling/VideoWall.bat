...
set CHROME_EXE=c:\Program Files (x86)\Google\Chrome\Application\chrome.exe
set CHROME_SETTINGS=%CHROME_SETTINGS% --app="data:text/html,<html><body><script>window.moveTo(1920,1080);window.resizeTo(1920,1080);window.location='https://sas.clemson.edu:8343/SASVisualAnalytics/report?location=/Shared Data/CEVAC/Hardin Hall Dive&type=Report.BI&section=vi532';</script></body></html>"
start "" "%CHROME_EXE%" %CHROME_SETTINGS%
